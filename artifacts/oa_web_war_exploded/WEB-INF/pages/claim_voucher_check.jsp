...
<%@page import="com.jmh.myoa.global.Contant" %>
                    ...
                    <form:form id="admin-form" name="addForm" action="/claim_voucher/check" modelAttribute="record">
                        ...
                        <div class="panel-body bg-light">
                            ...
                            <div class="panel-footer text-right">
                                ...
                                <c:if test="${sessionScope.employee.post==post['POST_FM'] || sessionScope.employee.post==post['POST_GM']}">
                                <button type="submit" class="button" name="dealWay" value="${deal['DEAL_PASS']}" >${deal['DEAL_PASS']}</button>
                                <button type="submit" class="button" name="dealWay" value="${deal['DEAL_BACK']}" >${deal['DEAL_BACK']}</button>
                                <button type="submit" class="button" name="dealWay" value="${deal['DEAL_REJECT']}" >${deal['DEAL_REJECT']}</button>
                                </c:if>
                                <c:if test="${sessionScope.employee.post==post['POST_CASHIER']}">
                                <button type="submit" class="button" name="dealWay" value="${deal['DEAL_PAID']}" >${deal['DEAL_PAID']}</button>
                                </c:if>
